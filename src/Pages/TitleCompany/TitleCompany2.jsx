...
const validationSchema = yup.object().shape({
  ...
  establishedyear: yup
    .number()
    .typeError("Years in established year must be a number")
    .required("Years in established year is required")
    .min(0, "Years in established year cannot be negative"),
});
...
export default function TitleCompany2() {
                ...
                {step === 1 && (
                  <>
                    <div className="flex justify-between items-center mb-4 text-[22px]  min-[1025px]:text-[26px] min-[1441px]:text-[32px] p-3 text-center font-semibold">
                      ...
                      <h2 className=" ">Basic Company Information</h2>
                  ...
                  <>
                    ...
                    <form className="space-y-6 sm:space-y-5 text-[14px] min-[1441px]:text-[18px] font-normal">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <InputField value={establishedyear} type='number'
                          onChange={(e) => setEstablishedyear(e.target.value)} placeholder="How many years have you been in operation?" />
                        {error.establishedyear && <p className="text-sm text-red-500">{error.establishedyear}</p>}
                      </div>
