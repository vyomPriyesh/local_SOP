...
const validationSchema8 = yup.object().shape({
  client_testimonial: yup.string().required("client testimonial is required"),
...
export default function RealEstateAgent() {
  ...
  const handleSave = async () => {
    ...
    formData.append("specific_neighborhoods", specific_neighborhoods || "");
    ...
    formData.append("short_bio", client_testimonial || "");
                    ...
                    <form className="space-y-6 sm:space-y-6 text-[14px] min-[1441px]:text-[18px] font-normal">
                      <div className="flex flex-col gap-2">
                        ...
                        <CustomTextArea
                          ...
                          value={specific_neighborhoods}
                          onChange={(e) =>
                            setSpecific_neighborhoods(e.target.value)
                          }
                        />
             ...
             checked:before:top-1/2 checked:before:-translate-x-1/2 checked:before:-translate-y-1/2"
                ...
                {step === 8 && (
                  <>
                    ...
                    <form
                      className="space-y-6 sm:space-y-6 text-[14px] min-[1441px]:text-[18px] font-normal"
                      onSubmit={handleSave}
                    >
                      <div className="flex flex-col gap-2">
                        {" "}
